Ext.define('build.statistics.anquanguanliShowtjPanel', {
    ...
    initBigParts: function () {
        ...
        this.toolBar = Ext.create('Ext.toolbar.Toolbar', {
            items: [me.ptype,me.sdate,me.edate,me.fst,me.username,me.qccid,'->',{
                xtype: 'button',
                text: '查询',
                iconCls: 'search',
                scope: this,
    ...
    initColumn: function () {
        this.columns = [
            ...
            {text: '&nbsp;&nbsp;时间', width: 70, dataIndex: 'username', renderer: qtipRenderers},
            {
                text: '安全管理及'+'<br/>'+'<br/>'+'&nbsp;'+'意外伤害'+'<br/>'+'<br/>'+'&nbsp;'+'事件例数',
                width: 95,
                dataIndex: 'type'
            }, {
                text: '安全管理及意外伤害事件',
