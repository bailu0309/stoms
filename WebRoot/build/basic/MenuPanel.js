Ext.define('build.basic.MenuPanel', {
    ...
    requires: [
        ...
        'Ext.tree.*',
        'Ext.ux.CheckColumn',
        'build.util.selector.ImageSelectorWindow'
    ],
    initComponent: function () {
        Ext.QuickTips.init();
        this.initStore();//初始化数据
        this.initColumn();//初始化columns
        this.imageWindow = Ext.create('build.util.selector.ImageSelectorWindow', {parentPanel: this});
        //按钮toolbar
        this.toolBar = Ext.create('Ext.toolbar.Toolbar', {
            items: [{
                ...
                handler: function () {
                    ...
                    this.menuPanel.getForm().findField('imageDisplay').update('');
            ...
            Ext.Ajax.request({
                ...
                success: function (resp) {
                    ...
                    if (obj.result == 'success') {
                        var msg = id == "" ? '新建 ' : '修改';
                        App.getApplication().msg('提示', msg + '菜单[ <font>' + name + '</font> ]成功');
                        try {
