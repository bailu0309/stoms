...
public class CellUtil {
    ...
    public static void setCellValue(HSSFCell cell, Object object) {
        if (object == null) {
            ...
            //如果是整数
            if (Utils.isWholenumber(String.valueOf(object))) {
                //如果在Integer的范围
                if (Utils.isInteger(String.valueOf(object))) {
                ...
                //如果带小数
            } else if (Utils.isDecimal(String.valueOf(object))) {
    ...
    public static void setCellValueNullZero(HSSFCell cell, Object object) {
        if (object == null) {
            cell.setCellValue(0);
        } else {
            //如果是整数
