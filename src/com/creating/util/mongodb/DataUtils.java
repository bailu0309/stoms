package com.creating.util.mongodb;
...
public class DataUtils {
	...
	public static String getBooleanDescribe(String str) {
		...
		if ("y".equalsIgnoreCase(str) || "yes".equalsIgnoreCase(str)
				...
				|| "是".equalsIgnoreCase(str) || "1".equalsIgnoreCase(str)) {
			return "是";
		} else if ("n".equalsIgnoreCase(str) || "no".equalsIgnoreCase(str)
				|| "false".equalsIgnoreCase(str) || "f".equalsIgnoreCase(str)
				|| "否".equalsIgnoreCase(str) || "0".equalsIgnoreCase(str)) {
			return "否";
