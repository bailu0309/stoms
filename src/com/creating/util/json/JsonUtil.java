...
public class JsonUtil {
    ...
    public static String YYYY_MM_DD_HH_MM_ss = "yyy-MM-dd HH:mm:ss";
    public static String HH_MM_ss = "HH:mm:ss";
    public static String YYYYMMDD = "yyyy/MM/dd";
    public static String YYYYMMDDHHMMSS = "yyy/MM/dd/HH/mm/ss";
    ...
    static {
        ...
        TimestampMorpher dm1 = new TimestampMorpher(new String[]{YYYY_MM_DD,
                YYYY_MM_DD_HH_MM_ss, HH_MM_ss, YYYYMMDD,
                YYYYMMDDHHMMSS, HHMMss});
        mr.registerMorpher(dm1);
    }
    ...
    public static String getJsonStr(Object obj) {
        ...
        jsonCfg.registerJsonValueProcessor(java.sql.Timestamp.class, new JsonDateValueProcessor("yyyy-MM-dd"));
        jsonCfg.registerJsonValueProcessor(java.sql.Date.class, new JsonDateValueProcessor("yyyy-MM-dd"));
        jsonCfg.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor("yyyy-MM-dd"));
